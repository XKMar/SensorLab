...
shell('index.html','首页',`<section class="hero"><img class="hero-image" src="assets/hero.jpg" width="1536" height="1024" alt="蓝色点云与轨迹构成的人体运动研究概念图"><div class="hero-content"><div class="eyebrow">PERCEPTION · MOTION · WORLD MODELS</div><h1>从视觉出发，<br>理解运动与世界。</h1><p>研究人体运动、视觉定位与世界模型，<br>连接真实观测与智能理解。</p><a href="research.html">探索我们的研究 ›</a></div><span class="caption">研究概念视觉</span></section><div class="container"><section class="intro"><h2>关于 ${esc(site.name)}</h2><p>${esc(site.subtitle)}关注人体运动、身份与交互的多模态理解，结合视觉、运动捕捉与力学测量，探索从真实观测到智能感知的方法。</p></section><section class="section"><div class="section-head"><h2>最新动态</h2><a href="news.html">全部新闻 ›</a></div>${newsList(news.slice(0,5))}</section><section class="section"><div class="section-head"><h2>研究工作</h2><a href="research.html">全部研究 ›</a></div>${publications.render()}</section><section class="section lab-platform" aria-labelledby="platform-title"><div class="platform-heading"><div><div class="eyebrow">RESEARCH PLATFORM · MULTIMODAL CAPTURE</div><h2 id="platform-title">真实观测，支持研究。</h2><p>在同一时间轴上连接人的动作、生理信号与环境响应，为可复现的多模态实验提供基础。</p></div><span class="platform-index">01 / 同步采集平台</span></div><figure class="platform-figure"><img src="assets/lab-platform-v2.webp" alt="实验平台概念可视化：多机位运动捕捉区、跑台、测力区域与计算机实验工作区" width="1672" height="941" loading="lazy"><figcaption>实验平台概念可视化 · 设备位置与实物配置以现场为准</figcaption><div class="platform-figure-tag" aria-hidden="true"><span class="sync-led"></span>共享硬件时间基准</div></figure><div class="platform-sync"><span class="sync-symbol" aria-hidden="true">↗</span><div><strong>五类设备，统一硬件同步。</strong><p>同一实验中对齐运动轨迹、多视角影像、地面反作用力、足底步态与肌电信号。</p></div><span class="sync-en">ONE CLOCK · MULTIPLE SIGNALS</span></div><div class="platform-equipment" aria-label="同步采集设备"><div><span>01 / MOTION</span><h3>Vicon 动捕</h3><p>记录三维运动轨迹</p></div><div><span>02 / VISION</span><h3>RGB 工业相机</h3><p>8 机位多视角采集</p></div><div><span>03 / FORCE</span><h3>AMTI 三维测力台</h3><p>采集地面反作用力</p></div><div><span>04 / GAIT</span><h3>zebris 跑台</h3><p>分析连续步态与足底信息</p></div><div><span>05 / MUSCLE</span><h3>肌电系统</h3><p>同步观察肌肉激活</p></div></div><div class="platform-footer"><div><span class="platform-caption">可接入交互对象</span><p>外骨骼 · 机器人 · 机械臂 · 机器狗</p></div><div><span class="platform-caption">研究场景</span><p>医疗与康复 · 具身智能 · 世界模型</p></div></div></section><section class="join-strip"><div><h2>带着你的问题，加入探索。</h2><p>对视觉、人体运动或世界模型感兴趣？从一个问题、一篇论文、一次实验开始。</p></div><a href="join.html">了解更多 ›</a></section></div>`);
