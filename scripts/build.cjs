...
<div class="section-head"><h2 id="platform-title">实验平台</h2></div><div class="platform-heading"><div class="eyebrow">HUMAN SENSING · EXPERIMENTAL PLATFORM</div><h3>测量人的状态，研究人与机器的交互。</h3><p>把运动轨迹、力学与生理信号放到具体任务中，研究人如何运动、状态如何变化，以及交互方式如何影响任务表现。</p></div>
...
<figure class="platform-figure"><img src="assets/lab-platform-layout-corrected.webp" alt="实验室空间布局：精细行为测量、生理信号测量、上肢与下肢交互及人机共驾平台" width="2350" height="1410" loading="lazy"></figure>
...
shell('research.html','研究',`<div class="container">${head('RESEARCH','研究工作','人体运动、身份识别与多模态视觉感知。')}<div class="page-body">${publications.render()}</div></div>`);
